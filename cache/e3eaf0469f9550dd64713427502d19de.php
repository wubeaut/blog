...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="index.php?m=adarticle&a=doDeleteab" method="post">
      ...
      <?php foreach ($data as $key =>$value):?>
              <tr>
                <td><input type="checkbox" class="input-control" name="check[]" value="<?=$value['id'];?>" /></td>
                <td class="article-title"><?=$value['content'];?></td>
                <td><?=$time=date('Y-m-d H:i:s',$value['addtime']);?></td>
                <td><a href="index.php?m=adarticle&a=doDelete&id=<?=$value['id'];?>" rel="1" name="see">删除</a> <a rel="1" name="delete"></a></td>
              </tr>
            <?php endforeach;?>
      <?php endif;?>
            </tbody>
        ...
        <footer class="message_footer">
          <nav>
            ...
            <ul class="pagination pagenav">
              ...
              <li><a href="index.php?m=adarticle&a=mood&page=<?=$allPage['first'];?>">首页</a></li>
              <li><a href="index.php?m=adarticle&a=mood&page=<?=$allPage['prev'];?>">上一页</a></li>
              <li><a href="index.php?m=adarticle&a=mood&page=<?=$allPage['next'];?>">下一页</a></li>
              <li><a href="index.php?m=adarticle&a=mood&page=<?=$allPage['end'];?>">尾页</a></li>
            </ul>
          </nav>
        </footer>
      </form>
