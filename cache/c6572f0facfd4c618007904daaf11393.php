...
<div class="moodlist">
  <h1 class="t_nav"><span>删删写写，回回忆忆，虽无法行云流水，却也可碎言碎语。</span><a href="index.php" class="n1">网站首页</a><a href="index.php?m=user&a=word" class="n2">留言板</a></h1>
  <div class="bloglist">
    <?php if(!empty($word)):?>
    ...
    <?php endforeach;?>
    <?php endif;?>
    <form action="index.php?m=user&a=doWord" method="post">
    <ul class="arrow_box">
         <div class="sy">
            ...
            <input class="reply_sub_a" type="submit" name="reply_sub" value="给我留言">
        </div>
    </ul>
  </form>
  </div>
  <div class="page"><a title="Total record"><b><?=$total;?></b></a><a href="index.php?m=user&a=word&page=<?=$allPage['first'];?>"><b>首页</b></a><a href="index.php?m=user&a=word&page=<?=$allPage['prev'];?>"><</a><a href="index.php?m=user&a=word&page=<?=$allPage['next'];?>">></a><a href="index.php?m=user&a=word&page=<?=$allPage['end'];?>">尾页</a></div>
</div>
<footer>
