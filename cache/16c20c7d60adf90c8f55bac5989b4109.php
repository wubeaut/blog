        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
			...
			<?php foreach ($data as $key =>$value):?>
              <tr>
                <td><input type="checkbox" class="input-control" name="check[]" value="<?=$value['rid'];?>" /></td>
                <td class="article-title"><?=$value['content'];?></td>
                <td><?=$time=date('Y-m-d H:i:s',$value['addtime']);?></td>
                <td><a href="index.php?m=adarticle&a=doDeleterp&rid=<?=$value['rid'];?>" rel="1" name="see">删除</a> <a rel="1" name="delete"></a></td>
              </tr>
            <?php endforeach;?>
			<?php endif;?>
            </tbody>
        ...
        <footer class="message_footer">
          <nav>
            ...
            <ul class="pagination pagenav">
              ...
              <li><a href="index.php?m=adarticle&a=comm&page=<?=$allPage['first'];?>">首页</a></li>
              <li><a href="index.php?m=adarticle&a=comm&page=<?=$allPage['prev'];?>">上一页</a></li>
              <li><a href="index.php?m=adarticle&a=comm&page=<?=$allPage['next'];?>">下一页</a></li>
              <li><a href="index.php?m=adarticle&a=comm&page=<?=$allPage['end'];?>">尾页</a></li>
            </ul>
          </nav>
        </footer>
      </form>
