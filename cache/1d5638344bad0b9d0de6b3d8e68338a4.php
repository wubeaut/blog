          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon1 glyphicon-bookmark1"></span> <span class="visible-lg"></span></th>
                <th><span class="glyphicon1 glyphicon-pushpin1"></span> <span class="visible-lg"></span></th>
                <th><span class="glyphicon1 glyphicon-time1"></span> <span class="visible-lg"></span></th>
			...
			<?php if(!empty($data)):?>
             <?php foreach ($data as $key=>$value):?>
              <tr>
                ...
                <td></td>
                <td></td>
                <td><a rel="1" name="see"></a> <a href="index.php?m=admin&a=doDetele&uid=<?=$value['uid'];?>" rel="1">删除</a>
				
				<?php if($value['allowlogin'] ==0):?>
				<a href="index.php?m=admin&a=doInserta&uid=<?=$value['uid'];?>&allowlogin=0">禁用</a>
				<?php else: ?>
				<a href="index.php?m=admin&a=doInserta&uid=<?=$value['uid'];?>&allowlogin=1">恢复</a>
				<?php endif;?>
				</td>
              </tr>
			  <?php endforeach;?>
