...
<section class="container-fluid">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="index.php"> <span class="badge">返回博客</span></a></li>
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="index.php?m=adarticle&a=doDeleteabc" method="post">
        <h1 class="page-header">管理 <span ></span></h1>
        <div class="table-responsive">
          <table class="table table-striped table-hover">
			...
			<?php foreach ($data as $key =>$value):?>
              <tr>
                <td><input type="checkbox" class="input-control" name="check[]" value="<?=$value['wid'];?>" /></td>
                <td class="article-title"><?=$value['content'];?></td>
                <td><?=$time=date('Y-m-d H:i:s',$value['addtime']);?></td>
                <td><a href="index.php?m=adarticle&a=doDeletew&wid=<?=$value['wid'];?>" rel="1" name="see">删除</a> <a rel="1" name="delete"></a></td>
              </tr>
            <?php endforeach;?>
			<?php endif;?>
            </tbody>
        ...
        <footer class="message_footer">
          <nav>
            ...
            <ul class="pagination pagenav">
              ...
              <li><a href="index.php?m=adarticle&a=word&page=<?=$allPage['first'];?>">首页</a></li>
              <li><a href="index.php?m=adarticle&a=word&page=<?=$allPage['prev'];?>">上一页</a></li>
              <li><a href="index.php?m=adarticle&a=word&page=<?=$allPage['next'];?>">下一页</a></li>
              <li><a href="index.php?m=adarticle&a=word&page=<?=$allPage['end'];?>">尾页</a></li>
            </ul>
          </nav>
        </footer>
      </form>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="./public/images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
