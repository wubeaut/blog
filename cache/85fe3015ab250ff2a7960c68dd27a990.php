...
<div class="newblog left">
  ...
  <?php foreach ($message as $value):?>
   <h2><?=$value['title'];?></h2>
    <p class="dateview"><span><?=$time = date('Y-m-d',$value['addtime']);?></span><span>作者：吴春芳</span><span>个人博客：[<a href="blog.wuchungangw.cn">我的博客</a>]</span></p>
...
<aside class="right">
 <form action="index.php?m=details&a=find" method="post">
   <div class="rnav">
     ...
     <input style="width:150px;height:25px;border-radius: 10px;border:1px solid  #f89854;" type="text" name="search" >&nbsp;<input style="width:50px;height: 25px;border-radius: 10px;background: #f89854;border:1px solid  #f89854;" type="submit" name="sub" value="搜索">  
    </div>
  </form>
<div class="news">
<h3>
